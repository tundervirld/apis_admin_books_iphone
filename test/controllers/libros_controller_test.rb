...
class LibrosControllerTest < ActionController::TestCase
  ...
  test "should create libro" do
    assert_difference('Libro.count') do
      post :create, libro: { autor: @libro.autor, genero: @libro.genero, nombre: @libro.nombre, publicado: @libro.publicado }
    end
  ...
  test "should update libro" do
    patch :update, id: @libro, libro: { autor: @libro.autor, genero: @libro.genero, nombre: @libro.nombre, publicado: @libro.publicado }
    assert_redirected_to libro_path(assigns(:libro))
  end
